...
map = {"0,0" : "시작", "0,1" : "타이베이", "0,2" : "황금열쇠", "0,3" : "베이징", "0,4" : "마닐라", "0,5" : "제주도", "0,6" : "싱가포르", "0,7" : "황금열쇠", "0,8" : "카이로", "0,9" : "이스탄불", "0,10" : "무인도",
        ...
        "8,0" : "컬럼비아호", "8,10" : "베를린",
        "9,0" : "도쿄", "9,10" : "오타와",
        "10,0" : "우주여행", "10,1" : "마드리드", "10,2" : "퀸 엘리자베스", "10,3" : "리스본", "10,4" : "하와이", "10,5" : "부산", "10,6" : "시드니", "10,7" : "상파울루", "10,8" : "황금열쇠", "10,9" : "부에노스 아이레스", "10,10" : "사회복지기금 접수처"
       }
...
landNum = ["시작", "타이베이", "황금열쇠", "베이징", "마닐라", "제주도", "싱가포르", "황금열쇠", "카이로", "이스탄불", "무인도",
           ...
           "부에노스 아이레스", "황금열쇠", "상파울루", "시드니", "부산", "하와이", "리스본", "퀸 엘리자베스", "마드리드", "우주여행",
...
url = {"init" : "http://15.165.88.215:8888/init",                                   # 초기화
       ...
       "pay" : "http://15.165.88.215:8888/player/toll?user_id={}&area_id={}&using_shield={}",  # 통행료 지불
       "payInfo" : "http://15.165.88.215:8888/player/toll/cost?area_id={}",                       # 통행료 정보
       ...
       "buyLand" : "http://15.165.88.215:8888/area/buy/{}?user_id={}&villa=1&building=0&hotel=0",    # 땅 구입
...
def gamePlay(screen):
    ...
    while True:
        ...
        # 이동 후 기능
        special_land = ["황금열쇠", "사회복지기금", "사회복지기금 접수처", "우주여행","무인도", "시작"]
